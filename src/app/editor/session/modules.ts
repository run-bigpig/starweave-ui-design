...
export function createEditorStoreModules(
  ...
  return {
    ...
    saveFigFileToURL: documentIO.saveFigFileToURL,
    ...
    getWorkspaceBinding: documentIO.getWorkspaceBinding,
    ...
    setWorkspaceDocumentSource: documentIO.setWorkspaceDocumentSource,
    createWorkspaceDocumentSource: documentIO.createWorkspaceDocumentSource,
