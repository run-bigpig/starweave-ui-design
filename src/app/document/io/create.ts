...
export function createDocumentIOActions(
  ...
  return {
    ...
    getWorkspaceBinding: sourceState.getWorkspaceBinding,
    ...
    setWorkspaceDocumentSource: sourceActions.setWorkspaceDocumentSource,
    createWorkspaceDocumentSource: sourceActions.createWorkspaceDocumentSource,
